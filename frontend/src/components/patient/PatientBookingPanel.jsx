...
export function DoctorBookingList({ allDoctors, onSelectDoctor, onBack }) {
        ...
        {available.map(d => (
          <div key={d.id} className="card glass-panel" style={{
            ...
            <div style={{
              ...
              marginTop: 'auto', paddingTop: '0.75rem', borderTop: '1px solid #e2e8f0'
            }}>
        ...
        <form onSubmit={onBook} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <textarea required value={symptoms} onChange={e => setSymptoms(e.target.value)}
              ...
              style={{ width: '100%', padding: '0.75rem', borderRadius: '4px', border: '1px solid #ccc', minHeight: '80px' }} />
          </div>
