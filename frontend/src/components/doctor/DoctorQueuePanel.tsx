...
export default function DoctorQueuePanel({ queue, activePatient, onSelectPatient, isAvailable, onToggleAvailability }: DoctorQueuePanelProps) {
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--spacing-lg)' }}>
        ...
        <Button variant="ghost" size="sm" onClick={onToggleAvailability}
          style={{ background: isAvailable ? 'var(--success-bg)' : 'var(--danger-bg)', color: isAvailable ? 'var(--success)' : 'var(--danger)' }}>
