...
class Config:
    ...
    JWT_COOKIE_SECURE = False  # set JWT_COOKIE_SECURE=true in production for HTTPS
    ...
    OTEL_EXPORTER_OTLP_ENDPOINT = _env("OTEL_EXPORTER_OTLP_ENDPOINT", None)
    OTEL_SERVICE_NAME = _env("OTEL_SERVICE_NAME", "pulse-hms")
